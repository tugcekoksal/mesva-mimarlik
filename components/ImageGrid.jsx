...
const ImageGrid = ({ projects }) => {
  const ImageItem = ({ src, name, project }) => (
    <div className="relative h-full w-full group overflow-hidden ">
      <img
        src={src}
        alt=""
        className="h-full w-full object-cover  grayscale group-hover:grayscale-0 transform group-hover:scale-105 transition-transform duration-300"
      />
  ...
  return (
    <div className="w-full h-[600px] overflow-hidden grid grid-cols-2 md:flex  mb-16 mt-10">
      <div className="flex flex-col gap-2 flex-1 p-1 sm:pl-0  ">
        <ImageItem
      ...
      <div className="flex-1 p-1 sm:pr-0 ">
        <ImageItem
